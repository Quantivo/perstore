...
exports.Notifying = function(store, options){
	...
	if(originalPut){
		store.put= function(object, directives){
            ...
            var tag = (options && options.subChannelGenerator) ? options.subChannelGenerator(object) : "";
            return when(tag, function(tag){
	...
	if(originalDelete){
		store["delete"] = function(id, directives){
            var tag = (options && options.subChannelGenerator) ? options.subChannelGenerator(id) : "";
            return when(tag, function(tag){
